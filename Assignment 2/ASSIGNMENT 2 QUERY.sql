...
CREATE TABLE Customers (
    CustomerID SERIAL PRIMARY KEY,  -- Auto-incremented primary key
    Name VARCHAR(255) NOT NULL,  -- Ensure name cannot be NULL
    ...
    CONSTRAINT email_check CHECK (Email LIKE '%@%.%')  -- Simple email format validation
);

-- Create Products Table
CREATE TABLE Products (
    ProductID SERIAL PRIMARY KEY,  -- Auto-incremented primary key
    ...
    Stock INT NOT NULL CHECK (Stock >= 0),  -- Stock should be non-negative
    CONSTRAINT unique_product UNIQUE (ProductName, Category)  -- Ensure product uniqueness per category
);

-- Create Orders Table
CREATE TABLE Orders (
    OrderID SERIAL PRIMARY KEY,  -- Auto-incremented primary key
    ...
    TotalAmount DECIMAL(10, 2) NOT NULL CHECK (TotalAmount >= 0),  -- Total amount should be non-negative
    CONSTRAINT fk_customer FOREIGN KEY (CustomerID) REFERENCES Customers(CustomerID) ON DELETE CASCADE
);

-- Create OrderDetails Table
CREATE TABLE OrderDetails (
    OrderDetailID SERIAL PRIMARY KEY,  -- Auto-incremented primary key
    ...
    Subtotal DECIMAL(10, 2) NOT NULL CHECK (Subtotal >= 0),  -- Subtotal should be non-negative
...
VALUES
('Amit Sharma', 'amitsharma@gmail.com', '2023-01-15'),
('Priya Deshmukh', 'priyadeshmukh@example.com', '2023-03-22'),
('Ravi Kumar', 'ravikumar@outlook.com', '2023-04-10'),
('Neha Gupta', 'nehagupta@ymail.com', '2023-06-05'),
('Suresh Reddy', 'sureshreddy@gmail.com', '2023-08-25'),
('Anjali Yadav', 'anjaliyadav@in.com', '2023-09-17');

-- Inserting Product Data
INSERT INTO Products (ProductName, Category, Price, Stock)
VALUES
('Samsung Galaxy S22', 'Electronics', 79999.99, 50),
('Apple iPhone 14', 'Electronics', 129999.99, 30),
('OnePlus 9 Pro', 'Electronics', 64999.99, 40),
('Nike Air Max', 'Footwear', 8999.99, 150),
('Adidas UltraBoost', 'Footwear', 13999.99, 100),
('Puma Running Shoes', 'Footwear', 7999.99, 120),
('Wooden Dining Table', 'Furniture', 29999.99, 20),
('King Size Bed', 'Furniture', 59999.99, 15),
('Ergonomic Office Chair', 'Furniture', 13999.99, 30),
('Organic Cotton Shirt', 'Apparel', 1799.99, 200),
('Levis Jeans', 'Apparel', 2999.99, 180),
('Ray-Ban Sunglasses', 'Apparel', 7999.99, 75);
...
VALUES
(1, '2024-02-10', 84999.98),  -- 1 year ago
(2, '2024-05-12', 158000.00),
(3, '2024-06-13', 45999.99),
(4, '2024-07-15', 42999.99),
(5, '2024-09-10', 109999.99),
(6, '2024-12-12', 22999.98),
(1, '2024-11-18', 77999.99),
(2, '2024-10-22', 134000.00),
(3, '2024-08-09', 52000.00),
(4, '2024-03-01', 45000.00),
(5, '2024-01-25', 89999.99),
(6, '2024-12-15', 18999.98);
...
SELECT total_spent_by_customer(5);
